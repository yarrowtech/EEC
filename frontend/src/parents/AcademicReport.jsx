  ...
  import { BookOpen, Award, TrendingUp, Download, Filter, ChevronDown } from 'lucide-react';
    ...
    return (
      <div className="p-6">
        ...
        <div className="bg-gradient-to-r from-yellow-400 to-yellow-500 rounded-xl p-6 mb-6 text-white">
          ...
          <p className="text-yellow-100">View academic performance and progress</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
          ...
          <div className="bg-white rounded-xl p-6 shadow-sm">
            <div className="text-center">
              <h3 className="text-2xl font-bold text-yellow-600">{academicData.currentGPA}</h3>
          ...
          <div className="bg-white rounded-xl p-6 shadow-sm">
            <div className="text-center">
              <h3 className="text-2xl font-bold text-blue-600">{academicData.rank}</h3>
          ...
          <div className="bg-white rounded-xl p-6 shadow-sm">
            <div className="text-center">
              <h3 className="text-2xl font-bold text-green-600">{academicData.totalStudents}</h3>
            ...
            <div key={index} className="bg-white rounded-xl p-6 shadow-sm">
              ...
              <div className="space-y-4">
                <div className="relative pt-1">
                  ...
                  <div className="overflow-hidden h-2 mt-1 text-xs flex rounded bg-yellow-100">
                    <div
                ...
                <div className="grid grid-cols-2 gap-4 mt-4">
                  <div className="text-center p-3 bg-gray-50 rounded-lg">
                    ...
                    <p className="text-lg font-semibold text-gray-800">{subject.assignments}</p>
                  </div>
                  <div className="text-center p-3 bg-gray-50 rounded-lg">
                    <p className="text-sm text-gray-500">Tests</p>
                    <p className="text-lg font-semibold text-gray-800">{subject.tests}</p>
                  </div>
                </div>
              </div>
            </div>
